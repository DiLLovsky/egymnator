...
if ($fbworppl == 'fbw') {
    if ($difficulty == 'beginner') {
        if ($experience == 'easy') {
            ...
            $e_legs_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowe uda' AND difficulty = 'Łatwy' AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_legs_A_run = mysqli_query($polaczenie, $e_legs_A);

            $e_chest = "SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND difficulty = 'Łatwy' AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 2";
            $e_chest_run = mysqli_query($polaczenie, $e_chest);

            $e_back = "SELECT * FROM exercises WHERE (body_part = 'Mięsień najszerszy grzbietu' OR body_part = 'Mięsień czworoboczny grzbietu') AND difficulty = 'Łatwy' AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 2";
            $e_back_run = mysqli_query($polaczenie, $e_back);

            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND difficulty = 'Łatwy' AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND difficulty = 'Łatwy' AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);
            ...
            $e_accessory = "SELECT * FROM exercises WHERE difficulty = 'Łatwy' AND exercise_type ='Akcesoryjny' AND exercise_type ='Akcesoryjny' ORDER BY RAND() LIMIT 4";
            $e_accessory_run = mysqli_query($polaczenie, $e_accessory);

            $e_legs_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień czworogłowy uda' AND difficulty = 'Łatwy' AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_legs_B_run = mysqli_query($polaczenie, $e_legs_B);
        } elseif ($experience == 'medium') {
            #FBW POCZĄTKUJĄCY ŚREDNI
            $e_legs_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowe uda' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 1";
            $e_legs_A_run = mysqli_query($polaczenie, $e_legs_A);

            $e_chest = "SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 2";
            $e_chest_run = mysqli_query($polaczenie, $e_chest);

            $e_back = "SELECT * FROM exercises WHERE (body_part = 'Mięsień najszerszy grzbietu' OR body_part = 'Mięsień czworoboczny grzbietu') AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 2";
            $e_back_run = mysqli_query($polaczenie, $e_back);

            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND difficulty = 'Łatwy' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND difficulty = 'Łatwy' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);

            $e_triceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień trójgłowy ramienia' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 2";
            $e_triceps_run = mysqli_query($polaczenie, $e_triceps);

            $e_biceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowy ramienia' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 2";
            $e_biceps_run = mysqli_query($polaczenie, $e_biceps);
            ...
            $e_legs_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień czworogłowy uda' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 1";
            $e_legs_B_run = mysqli_query($polaczenie, $e_legs_B);
        } else {
            #FBW POCZĄTKUJĄCY TRUDNY
            $e_legs_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowe uda' AND difficulty = 'Łatwy' AND exercise_type ='Główny' ORDER BY RAND() LIMIT 1";
            $e_legs_A_run = mysqli_query($polaczenie, $e_legs_A);

            $e_chest = "SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND difficulty = 'Łatwy' AND exercise_type ='Główny' ORDER BY RAND() LIMIT 2";
            $e_chest_run = mysqli_query($polaczenie, $e_chest);

            $e_back = "SELECT * FROM exercises WHERE (body_part = 'Mięsień najszerszy grzbietu' OR body_part = 'Mięsień czworoboczny grzbietu') AND difficulty = 'Łatwy' AND exercise_type ='Główny' ORDER BY RAND() LIMIT 2";
            $e_back_run = mysqli_query($polaczenie, $e_back);

            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND difficulty = 'Łatwy' AND (exercise_type ='Dodatkowy' OR exercise_type ='Główny') ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);
            ...
            $e_legs_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień czworogłowy uda' AND difficulty = 'Łatwy' AND exercise_type ='Główny' ORDER BY RAND() LIMIT 1";
            $e_legs_B_run = mysqli_query($polaczenie, $e_legs_B);
        }
    } elseif ($difficulty == 'intermediate') {
        if ($experience == 'easy') {
            #FBW ŚREDNIOZAAWANSOWANY ŁATWY
            $e_legs_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowe uda' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type ='Główny' ORDER BY RAND() LIMIT 1";
            $e_legs_A_run = mysqli_query($polaczenie, $e_legs_A);

            $e_chest = "SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type ='Główny' ORDER BY RAND() LIMIT 2";
            $e_chest_run = mysqli_query($polaczenie, $e_chest);

            $e_back = "SELECT * FROM exercises WHERE (body_part = 'Mięsień najszerszy grzbietu' OR body_part = 'Mięsień czworoboczny grzbietu') AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type ='Główny' ORDER BY RAND() LIMIT 2";
            $e_back_run = mysqli_query($polaczenie, $e_back);

            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND (exercise_type ='Akcesoryjny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND (exercise_type ='Akcesoryjny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);

            $e_triceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień trójgłowy ramienia' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type = 'Dodatkowy' ORDER BY RAND() LIMIT 2";
            $e_triceps_run = mysqli_query($polaczenie, $e_triceps);

            $e_biceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowy ramienia' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type = 'Dodatkowy' ORDER BY RAND() LIMIT 2";
            $e_biceps_run = mysqli_query($polaczenie, $e_biceps);

            $e_accessory = "SELECT * FROM exercises WHERE (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type = 'Akcesoryjny' ORDER BY RAND() LIMIT 4";
            $e_accessory_run = mysqli_query($polaczenie, $e_accessory);

            $e_legs_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień czworogłowy uda' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type ='Główny' ORDER BY RAND() LIMIT 1";
            $e_legs_B_run = mysqli_query($polaczenie, $e_legs_B);
        } elseif ($experience == 'medium') {
            ...
            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND (difficulty = 'Łatwy' OR difficulty = 'Średni') AND exercise_type ='Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);
            ...
            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND difficulty = 'Średni' AND exercise_type = 'Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND difficulty = 'Średni' AND exercise_type = 'Dodatkowy' ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);
        ...
        if ($experience == 'easy') {
            ...
            $e_legs_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowe uda' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_legs_A_run = mysqli_query($polaczenie, $e_legs_A);

            $e_chest = "SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy')";
            $e_chest_run = mysqli_query($polaczenie, $e_chest);

            $e_back = "SELECT * FROM exercises WHERE (body_part = 'Mięsień najszerszy grzbietu' OR body_part = 'Mięsień czworoboczny grzbietu') AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 2";
            $e_back_run = mysqli_query($polaczenie, $e_back);

            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND difficulty = 'Średni' AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND difficulty = 'Średni' AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);

            $e_triceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień trójgłowy ramienia' AND difficulty = 'Średni' AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 2";
            $e_triceps_run = mysqli_query($polaczenie, $e_triceps);

            $e_biceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowy ramienia' AND difficulty = 'Średni' AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 2";
            $e_biceps_run = mysqli_query($polaczenie, $e_biceps);
            ...
            $e_legs_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień czworogłowy uda' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_legs_B_run = mysqli_query($polaczenie, $e_legs_B);
        } elseif ($experience == 'medium') {
            ...
            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);

            $e_triceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień trójgłowy ramienia' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 2";
            $e_triceps_run = mysqli_query($polaczenie, $e_triceps);

            $e_biceps = "SELECT * FROM exercises WHERE body_part = 'Mięsień dwugłowy ramienia' AND (difficulty = 'Trudny' OR difficulty = 'Średni') AND (exercise_type ='Główny' OR exercise_type ='Dodatkowy') ORDER BY RAND() LIMIT 2";
            $e_biceps_run = mysqli_query($polaczenie, $e_biceps);
            ...
            $e_chest = "SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND difficulty = 'Trudny' AND exercise_type = 'Główny' UNION ALL SELECT * FROM exercises WHERE body_part = 'Mięsień klatki piersiowej' AND difficulty = 'Trudny' AND exercise_type = 'Główny'";
            $e_chest_run = mysqli_query($polaczenie, $e_chest);
            ...
            $e_arms_A = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część przednia' AND difficulty = 'Trudny' AND exercise_type ='Główny' ORDER BY RAND() LIMIT 1";
            $e_arms_A_run = mysqli_query($polaczenie, $e_arms_A);

            $e_arms_B = "SELECT * FROM exercises WHERE body_part = 'Mięsień naramienny - część środkowa' AND difficulty = 'Trudny' AND exercise_type ='Główny' ORDER BY RAND() LIMIT 1";
            $e_arms_B_run = mysqli_query($polaczenie, $e_arms_B);
            ...
            <form action="addtraining.php" method="POST">
                <div class="card">
                    ...
                    $name";
                            ...
                            Ramiona:
                            <?php
                            $rows = $e_arms_A_run->fetch_assoc();
                            $id_exercises = $rows['id_exercises'];
                            $name = $rows['name'];
                            echo "<input type ='hidden' name='arms_A' value='$id_exercises' /><br> 
                    $name";
                            ?><br><br>
                            Triceps:
                            <?php
                ...
                <div class="card">
                    ...
                    $name";
                            ...
                            Ramiona:
                            <?php
                            $rows = $e_arms_B_run->fetch_assoc();
                            $id_exercises = $rows['id_exercises'];
                            $name = $rows['name'];
                            echo "<input type ='hidden' name='arms_B' value='$id_exercises' /><br> 
                    $name";
                            ?><br><br>
                            Triceps:
                            <?php
                ...
                <div class="card">
                    <div class="training">
                        <p>Częstszym wyborem jest trenowanie w przedziale 8-12 powtórzeń. Zacznij od 8 powtórzeń a na następnym treningu zrób 9. Kiedy dojdziesz do 12 powtórzeń, zwiększ ciężar i zacznij powonie od 8 ruchów w jednej serii. Na początku swojej drogi zaczniej od 3 serii, aby później wykonywać po 4 serie każdego ćwiczenia.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="training">
                        <p>Można podzielić trening na hyper i strenght. Ten pierwszy jest wykonywany w 4 seriach po 8-12 powtórzeń a ten drugi w głównych ćwiczeniach (Przyiad, Martwy ciąg, wyciskanie sztangi itp.) po pięciu seriach po 5 powtórzeń</p>
                    </div>
                </div>
                <div class="card">
                    <div class="info">
                ...
                <div class="card">
                    <p><button type="submit" name="addtraining">Zatwierdź!</button>
                    </p>
                </div>
            </form>
            <div class="card">
                <p>
                    <button onClick="window.location.reload();">Chce inne ćwiczenia!</button>
                </p>
            </div>
        </div>
